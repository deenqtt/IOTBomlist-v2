  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'flex flex-col w-full max-w-lg bg-card border border-border rounded-xl shadow-2xl',
        'max-h-[92vh] overflow-hidden',
        // Emil: scale from 0.95 not 0 — nothing appears from nothing
        'data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
        'data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95',
        // Asymmetric: enter 200ms, exit 150ms (Emil: exit faster than enter)
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn('flex flex-col gap-1 px-6 py-4 border-b border-border shrink-0', className)}
    {...props}
  />
)
